...
namespace Lextm.SharpSnmpPro.Mib.Extensions
{
    ...
    public static class MibCodeGenerationUtility
    {
        ...
        /// <param name="includeFileName">Whether to include the original file name in the header.</param>
        public static void GenerateModuleHeader(StringBuilder sb, Module module, string version, bool isGeneratedFile, bool includeFileName)
        {
            if (isGeneratedFile)
            {
        ...
        public static string GenerateModuleCode(Module module, string version, bool isGeneratedFile, bool includeFileName)
        {
            var sb = new StringBuilder();
            GenerateModuleHeader(sb, module, version, isGeneratedFile, includeFileName);
